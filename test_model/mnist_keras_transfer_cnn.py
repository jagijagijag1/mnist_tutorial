...
# ADD model & weight output code
model_json_str = model.to_json()
open('mnist_keras_transfer_cnn_model.json', 'w').write(model_json_str)
model.save_weights('mnist_keras_transfer_cnn_weights.hdf5')
